...
class Train_Utils(object):
    ...
    def setup(self):
        ...
        cifar10_dataset = cifar10.get_dataset(dataset_type='train', aug=args.data_aug)
        
        # Split the train dataset and validation dataset 
        dataset_size = cifar10_dataset.__len__()
        val_size = int(validation_split*dataset_size)
        train_size = dataset_size - val_size
        self.datasets = {}
        self.datasets['train'], self.datasets['val'] = torch.utils.data.random_split(cifar10_dataset,[train_size, val_size])
        ...
        # Define the model
        self.model = getattr(models, args.model_name)(in_channel=cifar10.inputchannel, out_channel=cifar10.num_classes, pretrained=args.pretrained)
